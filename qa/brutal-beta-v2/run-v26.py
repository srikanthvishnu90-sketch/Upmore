#!/usr/bin/env python3
"""Brutal-beta v4 (v22 run): full scored production run of the 100-point rubric.
...
RESULTS_PATH = "/home/hatch/workspace/upmore/qa/brutal-beta-v2/results-v26.json"
