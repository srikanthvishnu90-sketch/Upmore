...
You are beta agent 03. Test BOTH: (1) can it do the function, (2) in retrospect, did it serve the underlying intent?
...
## Scenario
QUEUE CTA. Tap the top queue card's CTA button. Assert it does something real (walkthrough/guide opens) - not a dead tap. Navigate back to Home; queue still renders.
